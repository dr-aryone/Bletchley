...
# changes\additions made by shambles for V2.13r
#---------------------------------------------------------
...
class GameWindow(object):
    ...
    def click_button(self, row_index, button_index):
        ...
        self.attempt +=1 #add 1 as row_index ordered from 0-5 not 1-6
    ...
    def new_game(self):
        ...
        self.MAIN_MENU.add_command(
            ...
            command=partial(
                showinfo,
                "About",
                "Bletchley V2.13r by Steve Shambles jan 2019",
            ),
        )
        ...
        self.HEADER_FRAME = LabelFrame(
            self.ROOT, fg="blue", text="Bletchley V2.13r"
        )

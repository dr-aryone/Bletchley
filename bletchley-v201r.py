...
'''
# Minor changes made by shambles for v2.01r
#--------------------------------------------
# made main window non-resizable
# line 202: self.ROOT.resizable(False, False).

# changed version number throughout code to v2.01r
# to reflect this will be 2nd release.

# line 260: Changed message that said "blank = no colours" to
# "0000 = No colours in code" 

# Bug: music does not stop when quit by window x click, or
# selecting a new game.
# although this might dissapear when frozen as exe?

# To do:
# make GUI border nicer.
    ...
    def new_game(self):
        ...
        self.MAIN_MENU.add_command(
            ...
            command=partial(
                showinfo,
                "About",
                "Bletchley V2.01r by Steve Shambles jan 2019",
            ),
        )
        ...
        self.HEADER_FRAME = LabelFrame(
            self.ROOT, fg="blue", text="Bletchley V2.01r", relief=SUNKEN
        )
        ...
        self.HEADER_LABEL.grid(pady=4, padx=4)

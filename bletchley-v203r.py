...
'''
# changes\additions made by shambles for v2.03r
#-----------------------------------------------
# Edited and added 'how to play' pop up.
# Had no choice but to add geometary to main window to resize properly an
# get a decent edging around the frame.
# Changed text on reveal button to look bigger and better.
# play tested 25 games with no problems encountered.
    ...
    def new_game(self):
        ...
        self.MAIN_MENU.add_command(
            ...
            command=partial(
                showinfo,
                "About",
                "Bletchley V2.03r by Steve Shambles jan 2019",
            ),
        )
        ...
        self.HEADER_FRAME = LabelFrame(
            self.ROOT, fg="blue", text="Bletchley V2.03r"
        )

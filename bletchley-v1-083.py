...
from tkinter import Tk, Button, Label, LabelFrame, messagebox, Menu,  \
...
FILE_MENU2.add_command(label='Free music from Bensound.com', command=visit_bensound)
...
class outcome:
  ...
  def glue_outcomes_together(self):
    ...
    self.out_come = str(self.out_come1)+str(self.out_come2)+str(self.out_come3)+str(self.out_come4)



class button_up_row1:
  ''' Variabless for button colours for row 1. '''
  def __init__(self, but_col_1_1, current_but_col, but_col_1_2, current_but_col2, but_col_1_3, current_but_col3, but_col_1_4, current_but_col4):
...
def decode_row1():
    ...
    if s1.but_col_1_1 == 0 or s1.but_col_1_2 == 0   \
    or s1.but_col_1_3 == 0 or s1.but_col_1_4 == 0:
        return
...
def clk_but_1_1():
    ...
    BUT1_1 = Button(FRAME1, bg=s1.current_but_col, text=' ', command=clk_but_1_1)
    BUT1_1.grid(row=7, column=0, pady=4, padx=4)
...
def clk_but_1_2():
    ...
    BUT1_2 = Button(FRAME1, bg=s1.current_but_col2, text=' ', command=clk_but_1_2)
    BUT1_2.grid(row=7, column=1, pady=4, padx=4)
...
def clk_but_1_3():
    ...
    BUT1_3 = Button(FRAME1, bg=s1.current_but_col3, text=' ', command=clk_but_1_3)
    BUT1_3.grid(row=7, column=2, pady=4, padx=4)
...
def clk_but_1_4():
    ...
    BUT1_4 = Button(FRAME1, bg=s1.current_but_col4, text=' ', command=clk_but_1_4)
    BUT1_4.grid(row=7, column=3, pady=4, padx=4)
...
def decode_row2():
    ...
    if t1.but_col_2_1 == 0 or t1.but_col_2_2 == 0 or t1.but_col_2_3 == 0 or t1.but_col_2_4 == 0:
        return
...
def clk_but_2_1():
    ...
    BUT2_1 = Button(FRAME2, bg=s1.current_but_col, text=' ', command=clk_but_2_1)
    BUT2_1.grid(row=8, column=0, pady=4, padx=4)
...
def clk_but_2_2():
    ...
    BUT2_2 = Button(FRAME2, bg=s1.current_but_col2, text=' ', command=clk_but_2_2)
    BUT2_2.grid(row=8, column=1, pady=4, padx=4)
...
def clk_but_2_3():
    ...
    BUT2_3 = Button(FRAME2, bg=s1.current_but_col3, text=' ', command=clk_but_2_3)
    BUT2_3.grid(row=8, column=2, pady=4, padx=4)
...
def clk_but_2_4():
    ...
    BUT2_4 = Button(FRAME2, bg=s1.current_but_col4, text=' ', command=clk_but_2_4)
    BUT2_4.grid(row=8, column=3, pady=4, padx=4)
...
def decode_row3():
    ...
    if u1.but_col_3_1 == 0 or u1.but_col_3_2 == 0 or u1.but_col_3_3 == 0 or u1.but_col_3_4 == 0:
        return
...
def clk_but_3_1():
    ...
    BUT3_1 = Button(FRAME3, bg=s1.current_but_col, text=' ', command=clk_but_3_1)
    BUT3_1.grid(row=9, column=0, pady=4, padx=4)
...
def clk_but_3_2():
    ...
    BUT3_2 = Button(FRAME3, bg=s1.current_but_col2, text=' ', command=clk_but_3_2)
    BUT3_2.grid(row=9, column=1, pady=4, padx=4)
...
def clk_but_3_3():
    ...
    BUT3_3 = Button(FRAME3, bg=s1.current_but_col3, text=' ', command=clk_but_3_3)
    BUT3_3.grid(row=9, column=2, pady=4, padx=4)
...
def clk_but_3_4():
    ...
    BUT3_4 = Button(FRAME3, bg=s1.current_but_col4, text=' ', command=clk_but_3_4)
    BUT3_4.grid(row=9, column=3, pady=4, padx=4)
...
def decode_row4():
    ...
    if v1.but_col_4_1 == 0 or v1.but_col_4_2 == 0 or v1.but_col_4_3 == 0 or v1.but_col_4_4 == 0:
        return
...
def clk_but_4_1():
    ...
    BUT4_1 = Button(FRAME4, bg=s1.current_but_col, text=' ', command=clk_but_4_1)
    BUT4_1.grid(row=10, column=0, pady=4, padx=4)
...
def clk_but_4_2():
    ...
    BUT4_2 = Button(FRAME4, bg=s1.current_but_col2, text=' ', command=clk_but_4_2)
    BUT4_2.grid(row=10, column=1, pady=4, padx=4)
...
def clk_but_4_3():
    ...
    BUT4_3 = Button(FRAME4, bg=s1.current_but_col3, text=' ', command=clk_but_4_3)
    BUT4_3.grid(row=10, column=2, pady=4, padx=4)
...
def clk_but_4_4():
    ...
    BUT4_4 = Button(FRAME4, bg=s1.current_but_col4, text=' ', command=clk_but_4_4)
    BUT4_4.grid(row=10, column=3, pady=4, padx=4)
...
def decode_row5():
    ...
    if w1.but_col_5_1 == 0 or w1.but_col_5_2 == 0 or w1.but_col_5_3 == 0 or w1.but_col_5_4 == 0:
        return
...
def clk_but_5_1():
    ...
    BUT5_1 = Button(FRAME5, bg=s1.current_but_col, text=' ', command=clk_but_5_1)
    BUT5_1.grid(row=11, column=0, pady=4, padx=4)
...
def clk_but_5_2():
    ...
    BUT5_2 = Button(FRAME5, bg=s1.current_but_col2, text=' ', command=clk_but_5_2)
    BUT5_2.grid(row=11, column=1, pady=4, padx=4)
...
def clk_but_5_3():
    ...
    BUT5_3 = Button(FRAME5, bg=s1.current_but_col3, text=' ', command=clk_but_5_3)
    BUT5_3.grid(row=11, column=2, pady=4, padx=4)
...
def clk_but_5_4():
    ...
    BUT5_4 = Button(FRAME5, bg=s1.current_but_col4, text=' ', command=clk_but_5_4)
    BUT5_4.grid(row=11, column=3, pady=4, padx=4)
...
def decode_row6():
    ...
    if x1.but_col_6_1 == 0 or x1.but_col_6_2 == 0 or x1.but_col_6_3 == 0 or x1.but_col_6_4 == 0:
        return
...
def clk_but_6_1():
    ...
    BUT6_1 = Button(FRAME6, bg=s1.current_but_col, text=' ', command=clk_but_6_1)
    BUT6_1.grid(row=12, column=0, pady=4, padx=4)
...
def clk_but_6_2():
    ...
    BUT6_2 = Button(FRAME6, bg=s1.current_but_col2, text=' ', command=clk_but_6_2)
    BUT6_2.grid(row=12, column=1, pady=4, padx=4)
...
def clk_but_6_3():
    ...
    BUT6_3 = Button(FRAME6, bg=s1.current_but_col3, text=' ', command=clk_but_6_3)
    BUT6_3.grid(row=12, column=2, pady=4, padx=4)
...
def clk_but_6_4():
    ...
    BUT6_4 = Button(FRAME6, bg=s1.current_but_col4, text=' ', command=clk_but_6_4)
    BUT6_4.grid(row=12, column=3, pady=4, padx=4)
...
def check_victory():
    ...
    messagebox.showinfo('Bletchley', 'You genius, '  \
...
FRAME10.grid()
LAB10= Label(FRAME10, text="Can you crack the code?\n\n"  \

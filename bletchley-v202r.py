...
By Steve Shambles, 26th Jan 2019.
...
to help sort out my poor code.

For more Python projects:
https://stevepython.wordpress.com/

'''
# changes\additions made by shambles for v2.02r
#-----------------------------------------------
# Added 'how to play' instructions pop-up message in the
# drop down menu. Lines 208-222.

# Capitalised the word Solution line 341.

# To do:
# Make main game window slighter bigger in width and height.
# It looks odd, and border looks thin.
# If I use self.ROOT.geometarey(width,height)
# it may make the screen size dodgy on other systems,
    ...
    def new_game(self):
        ...
        self.MAIN_MENU.add_command(
            ...
            command=partial(
                ...
                "A '*' means correct colour and correct position.\n"
                "A 'X' means you have got the colour correct, but in the wrong position.\n"
                "'0000' means you got no colours at all in the code.\n\n"
        ...
        self.MAIN_MENU.add_command(
            ...
            command=partial(
                showinfo,
                "About",
                "Bletchley V2.02r by Steve Shambles jan 2019",
            ),
        )
        ...
        self.HEADER_FRAME = LabelFrame(
            self.ROOT, fg="blue", text="Bletchley V2.02r", relief=SUNKEN
        )
        ...
        self.SOLUTION_FRAME = LabelFrame(
            self.ROOT, fg="blue", text="Solution", relief=SUNKEN
        )

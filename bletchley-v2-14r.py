...
# changes\additions made by shambles for V2.14r
#---------------------------------------------------------
# Fixed a few PEP8 things using Pylint, was rated 5.15 now 7.46.

# Added graphiic to top panel. file 'blt-panel-v2.png' now required
# in current dir, added error check for that.

# resized window slightly again
    ...
    def new_game(self):
        ...
        self.MAIN_MENU.add_command(
            ...
            command=partial(
                showinfo,
                "About",
                "Bletchley V2.14r by Steve Shambles Feb 2019",
            ),
        )
